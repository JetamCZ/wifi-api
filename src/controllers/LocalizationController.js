...
class LocalizationController {
    ...
    async localize(localization) {
        ...
        localization.customLocalizationData.caclulatingTimes.populatePlan = new Date() - startTime - localization.customLocalizationData.caclulatingTimes.total
        ...
        localization.customLocalizationData.caclulatingTimes.populateBeacons = new Date() - startTime - localization.customLocalizationData.caclulatingTimes.total
        localization.customLocalizationData.caclulatingTimes.total = new Date() - startTime
        ...
        localization.customLocalizationData.caclulatingTimes.getDeviceData = new Date() - startTime - localization.customLocalizationData.caclulatingTimes.total
        localization.customLocalizationData.caclulatingTimes.total = new Date() - startTime
        ...
        localization.customLocalizationData.caclulatingTimes.fingerPrinting = new Date() - startTime - localization.customLocalizationData.caclulatingTimes.total
        localization.customLocalizationData.caclulatingTimes.total = new Date() - startTime

        //populate geted data
        localization = await this.populateDeviceNames(localization)

        localization.customLocalizationData.caclulatingTimes.populateDeviceNames = new Date() - startTime - localization.customLocalizationData.caclulatingTimes.total
        localization.customLocalizationData.caclulatingTimes.total = new Date() - startTime
